...
export const ar = {
  ...
  // Designed error / empty surfaces (Phase 6).
  pages: {
    notFound: {
      code: "404",
      title: "الصفحة غير موجودة",
      lead: "تعذّر العثور على الصفحة التي تبحث عنها. قد يكون الرابط قديمًا أو غير صحيح.",
    ...
    error: {
      ...
      lead: "واجهنا مشكلة أثناء تحميل هذه الصفحة. جرّب إعادة المحاولة.",
